...
Data is stored on a highscore list depending on amount of devices affected.

Rating from current date in relation to zero-day and patches applied determine score
...
```sh
git clone https://github.com/GPT-Engineer-App/hacker-news-top5.git
cd hacker-news-top5
npm i
```
